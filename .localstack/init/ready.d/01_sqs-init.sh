...
awslocal sqs create-queue --region eu-west-1 --queue-name road-registry-admin.fifo --attributes FifoQueue=true,ContentBasedDeduplication=true,DeduplicationScope=messageGroup
