...
public class RoadNetworkEventProcessor : EditorContextEventProcessor
{
    public RoadNetworkEventProcessor(
        ...
        : base(WellKnownProjectionStateNames.RoadRegistryEditorRoadNetworkProjectionHost, streamStore, projections.Filter, envelopeFactory, projections.Resolver, dbContextFactory, scheduler, loggerFactory, configuration)
    {
    }
}
