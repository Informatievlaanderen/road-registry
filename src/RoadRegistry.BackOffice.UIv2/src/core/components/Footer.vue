<template>
  <footer>
    <div style="height: 0px; width: 0px; position: absolute; visibility: hidden; display: none">
      <svg xml:space="http://www.w3.org/2000/svg">
        <symbol id="vlaanderen-logo" viewBox="0 0 19.61 31.05">
