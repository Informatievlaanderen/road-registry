namespace Shaperon
{
    ...
    public class DbaseCodePage : IEquatable<DbaseCodePage>
    {
        ...
        public static readonly DbaseCodePage System_Windows_ANSI_Alias1 = new DbaseCodePage(0x3, Encoding.Default.CodePage);
        ...
        public static readonly DbaseCodePage System_Windows_ANSI_Alias2 = new DbaseCodePage(0x57, Encoding.Default.CodePage);
