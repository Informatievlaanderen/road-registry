...
// Maps V1 (legacy) domain values to their V2 equivalents for the WMS v2 product, using the same migration tables as the
...
// Where those writers throw for an unmapped value, WMS v2 returns null instead - the product stores null when no mapping was possible.
