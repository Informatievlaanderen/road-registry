...
public class RoadSegmentNationalRoadAttributeLatestItemConfiguration : IEntityTypeConfiguration<RoadSegmentNationalRoadAttributeLatestItem>
{
    ...
    public void Configure(EntityTypeBuilder<RoadSegmentNationalRoadAttributeLatestItem> b)
    {
        ...
        b.Property(RoadSegmentNationalRoadAttributeLatestItem.VersionTimestampBackingPropertyName).HasColumnName("version_timestamp");
        b.Property(x => x.CreatedOnAsString).HasColumnName("created_on_as_string");
        b.Property(RoadSegmentNationalRoadAttributeLatestItem.CreatedOnTimestampBackingPropertyName).HasColumnName("created_on_timestamp");
        ...
        b.HasIndex(RoadSegmentNationalRoadAttributeLatestItem.VersionTimestampBackingPropertyName);
