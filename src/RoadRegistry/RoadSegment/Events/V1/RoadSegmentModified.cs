...
public class RoadSegmentModified : IMartenEvent
{
    public const string EventName = "RoadSegmentModified"; // BE CAREFUL CHANGING THIS!!
    ...
    public required bool ConvertedFromOutlined { get; set; }
