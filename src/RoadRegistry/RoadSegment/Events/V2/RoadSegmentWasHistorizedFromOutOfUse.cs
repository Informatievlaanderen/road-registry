...
// A 'buiten gebruik' road segment was opgeheven and now counts as 'gehistoreerd'.
//
...
public record RoadSegmentWasHistorizedFromOutOfUse : IRoadSegmentUnconnectedStatusChangeEvent
{
    public const string EventName = "RoadSegmentWasHistorizedFromOutOfUse"; // BE CAREFUL CHANGING THIS!!
