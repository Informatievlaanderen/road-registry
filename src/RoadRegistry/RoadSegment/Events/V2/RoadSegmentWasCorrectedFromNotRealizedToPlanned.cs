...
// A 'niet gerealiseerd' road segment was corrected back to 'gepland'.
//
...
public record RoadSegmentWasCorrectedFromNotRealizedToPlanned : IRoadSegmentUnconnectedStatusChangeEvent
{
    public const string EventName = "RoadSegmentWasCorrectedFromNotRealizedToPlanned"; // BE CAREFUL CHANGING THIS!!
