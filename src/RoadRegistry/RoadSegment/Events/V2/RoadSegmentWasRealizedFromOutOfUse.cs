...
// A 'buiten gebruik' road segment was taken back into use: it was knotted into the network and now counts as
// 'gerealiseerd'. The status the segment takes on is the event itself, so it is not carried as a field.
//
...
public record RoadSegmentWasRealizedFromOutOfUse : IRoadSegmentWasConnectedEvent
{
    public const string EventName = "RoadSegmentWasRealizedFromOutOfUse"; // BE CAREFUL CHANGING THIS!!
