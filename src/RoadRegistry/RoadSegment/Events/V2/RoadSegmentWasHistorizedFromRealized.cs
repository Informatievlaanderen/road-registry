...
// A 'gerealiseerd' road segment was opgeheven and now counts as 'gehistoreerd', which unhooks it from the network.
// The status it takes on is the event itself, so it is not carried as a field.
//
...
public record RoadSegmentWasHistorizedFromRealized : IRoadSegmentWasDisconnectedEvent
{
    public const string EventName = "RoadSegmentWasHistorizedFromRealized"; // BE CAREFUL CHANGING THIS!!
