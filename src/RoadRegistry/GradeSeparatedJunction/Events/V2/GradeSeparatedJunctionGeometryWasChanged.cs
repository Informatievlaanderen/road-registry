...
public record GradeSeparatedJunctionGeometryWasChanged : IMartenEvent
{
    public const string EventName = "GradeSeparatedJunctionGeometryWasChanged"; // BE CAREFUL CHANGING THIS!!
