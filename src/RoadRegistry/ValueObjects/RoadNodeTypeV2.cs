    ...
    public static readonly RoadNodeTypeV2 Schijnknoop =
        new(
            ...
            new DutchTranslation(
                11,
                "schijnknoop",
                "Een schijnknoop is een wegknoop die geplaatst werd op plaatsen waar domeinwaarden van een wegsegment wijzigen. Schijnknopen hebben steeds twee aansluitende wegsegmenten."
            )
        );
