namespace RoadRegistry.Projections.RoadSegmentDynamicLaneAttribute
{
    ...
    public class RoadSegmentDynamicLaneAttributeDbaseRecord : DbaseRecord
    {
        public static readonly RoadSegmentDynamicLaneAttributeDbaseSchema Schema = new RoadSegmentDynamicLaneAttributeDbaseSchema();

        public RoadSegmentDynamicLaneAttributeDbaseRecord()
        {
