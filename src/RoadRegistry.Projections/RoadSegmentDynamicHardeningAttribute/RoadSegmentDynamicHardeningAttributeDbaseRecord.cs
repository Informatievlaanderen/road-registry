namespace RoadRegistry.Projections
{
    ...
    public class RoadSegmentDynamicHardeningAttributeDbaseRecord : DbaseRecord
    {
        public static readonly RoadSegmentDynamicHardeningAttributeDbaseSchema Schema = new RoadSegmentDynamicHardeningAttributeDbaseSchema();
