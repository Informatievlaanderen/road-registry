...
public class CorrectRoadNodeVersionsSqsRequestHandler : SqsHandler<CorrectRoadNodeVersionsSqsRequest>
{
    ...
    public CorrectRoadNodeVersionsSqsRequestHandler(IBackOfficeS3SqsQueue sqsQueue, ITicketing ticketing, ITicketingUrl ticketingUrl) : base(sqsQueue, ticketing, ticketingUrl)
    {
    }
