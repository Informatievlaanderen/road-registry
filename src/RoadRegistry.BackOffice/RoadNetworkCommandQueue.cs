namespace RoadRegistry.BackOffice
{
    ...
    {
        public static readonly StreamName Stream = new StreamName("roadnetwork-command-queue");
        ...
        public async Task Write(Command command, CancellationToken cancellationToken)
        {
            var jsonMetadata = JsonConvert.SerializeObject(
                new RoadNetworkCommandMetadata
                {
                    Principal = command
                        .Principal
                        .Claims
        ...
        private class RoadNetworkCommandMetadata
        {
