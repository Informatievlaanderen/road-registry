...
public class RoadNetworkExtractUpload
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var problems = await validator.ValidateAsync(archive, zipArchiveMetadata, cancellationToken);
        ...
        else
        {
            ...
            {
                await emailClient.SendAsync(new (_downloadId, _extractDescription), cancellationToken);
            }
        }
