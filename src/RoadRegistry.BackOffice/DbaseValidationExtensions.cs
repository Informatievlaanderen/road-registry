namespace RoadRegistry.BackOffice
{
    ...
    public static class ValidationExtensions
    {
            ...
            where T : IRoadSegmentDbaseRecord
        {
            ...
            else if (!RoadSegmentStatus.ByIdentifier.TryGetValue(record.STATUS.Value, out var status) || !status.IsValidForRoadSegmentOutline())
            {
            ...
            else if (!RoadSegmentMorphology.ByIdentifier.TryGetValue(record.MORFOLOGIE.Value, out var morphology) || !morphology.IsValidForRoadSegmentOutline())
            {
