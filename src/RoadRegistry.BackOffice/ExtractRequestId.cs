namespace RoadRegistry.BackOffice
{
    ...
    public readonly struct ExtractRequestId : IEquatable<ExtractRequestId>
    {
        ...
        public static bool operator ==(ExtractRequestId left, ExtractRequestId right) => left.Equals(right);
        public static bool operator !=(ExtractRequestId left, ExtractRequestId right) => !left.Equals(right);
        public static implicit operator string(ExtractRequestId instance) => instance.ToString();
    }
}
