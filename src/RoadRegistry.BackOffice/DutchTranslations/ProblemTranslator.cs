...
public static class ProblemTranslator
{
    private static readonly Dictionary<ProblemCode, Converter<Problem, ProblemTranslation>> ProblemCodeDutchTranslators = new()
    {
        ...
        {ProblemCode.RoadSegment.GeometryDrawMethod.NotValid, problem => new(problem.Severity, "GeometrieMethodeNietCorrect", $"Geometrie methode is foutief. '{problem.Parameters[0].Value}' is geen geldige waarde.") },
        ...
        {ProblemCode.RoadSegment.Lane.GreaterThanZero, problem => new(problem.Severity, "AantalRijstrokenVerplicht", "Aantal rijstroken moet groter dan nul zijn.")}, //TODO-rik dit zou een andere code moeten zijn
        ...
        {ProblemCode.RoadSegment.Width.GreaterThanZero, problem => new(problem.Severity, "WegbreedteVerplicht", "Wegbreedte moet groter dan nul zijn.") }, //TODO-rik te bekijken, dit zou een andere code moeten zijn
