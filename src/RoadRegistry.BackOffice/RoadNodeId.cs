namespace RoadRegistry.BackOffice
{
    ...
    public readonly struct RoadNodeId : IEquatable<RoadNodeId>, IComparable<RoadNodeId>
    {
        ...
        public override bool Equals(object obj) => obj is RoadNodeId id && Equals(id);
        
        public override int GetHashCode() => _value.GetHashCode(); public override string ToString() => _value.ToString(CultureInfo.InvariantCulture);
