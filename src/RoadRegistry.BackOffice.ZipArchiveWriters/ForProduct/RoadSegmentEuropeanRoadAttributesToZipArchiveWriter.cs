...
public class RoadSegmentEuropeanRoadAttributesToZipArchiveWriter : IZipArchiveWriter<ProductContext>
{
    ...
    public async Task WriteAsync(ZipArchive archive, ProductContext context, CancellationToken cancellationToken)
    {
        ...
        var count = await _inwinningFilter.CountRoadSegmentRecordsAsync(context.RoadSegmentEuropeanRoadAttributes.Select(_ => _.RoadSegmentId), cancellationToken);
                   ...
                   new BinaryWriter(dbfEntryStream, _encoding, true)))
        {
            ...
            foreach (var data in context.RoadSegmentEuropeanRoadAttributes
                         .OrderBy(_ => _.Id)
