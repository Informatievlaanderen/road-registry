...
public class RoadSegmentSurfaceAttributesToZipArchiveWriter : IZipArchiveWriter<ProductContext>
{
    ...
    public RoadSegmentSurfaceAttributesToZipArchiveWriter(string entryFormat, RecyclableMemoryStreamManager manager, Encoding encoding, ProductInwinningFilter? inwinningFilter = null)
    {
    ...
    public async Task WriteAsync(ZipArchive archive, ProductContext context, CancellationToken cancellationToken)
    {
        ...
        var count = await _inwinningFilter.CountRoadSegmentRecordsAsync(context.RoadSegmentSurfaceAttributes.Select(_ => _.RoadSegmentId), cancellationToken);
                   ...
                   new BinaryWriter(dbfEntryStream, _encoding, true)))
        {
            ...
            foreach (var data in context.RoadSegmentSurfaceAttributes
                         .OrderBy(_ => _.Id)
