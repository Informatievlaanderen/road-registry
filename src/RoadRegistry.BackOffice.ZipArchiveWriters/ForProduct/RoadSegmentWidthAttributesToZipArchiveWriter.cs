...
public class RoadSegmentWidthAttributesToZipArchiveWriter : IZipArchiveWriter<ProductContext>
{
    ...
    public RoadSegmentWidthAttributesToZipArchiveWriter(string entryFormat, RecyclableMemoryStreamManager manager, Encoding encoding, ProductInwinningFilter? inwinningFilter = null)
    {
    ...
    public async Task WriteAsync(ZipArchive archive, ProductContext context, CancellationToken cancellationToken)
    {
        ...
        var count = await _inwinningFilter.CountRoadSegmentRecordsAsync(context.RoadSegmentWidthAttributes.Select(_ => _.RoadSegmentId), cancellationToken);
                   ...
                   new BinaryWriter(dbfEntryStream, _encoding, true)))
        {
            ...
            foreach (var data in context.RoadSegmentWidthAttributes
                         .OrderBy(_ => _.Id)
