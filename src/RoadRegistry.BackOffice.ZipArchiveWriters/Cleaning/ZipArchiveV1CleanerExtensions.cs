...
public static class ZipArchiveV1CleanerExtensions
{
    public static bool UpdateRoadSegmentAttributeMissingFromOrToPositionsOnZipArchiveV1<TDbaseRecord>(this ZipArchive archive,
