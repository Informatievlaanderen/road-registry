...
public partial class ChangeFeedController
{
    ...
    /// <exception cref="System.ComponentModel.DataAnnotations.ValidationException">new[] { new ValidationFailure("BeforeEntry", "BeforeEntry query string parameter is missing.") }</exception>
    ...
    /// <exception cref="System.ComponentModel.DataAnnotations.ValidationException">new[] { new ValidationFailure("BeforeEntry", "BeforeEntry query string parameter requires exactly 1 value.") }</exception>
    ...
    /// <exception cref="System.ComponentModel.DataAnnotations.ValidationException">new[] { new ValidationFailure("BeforeEntry", "BeforeEntry query string parameter value must be an integer.") }</exception>
    ...
    /// <exception cref="Microsoft.IdentityModel.Tokens.ValidationFailure">BeforeEntry - BeforeEntry query string parameter is missing.</exception>
    ...
    /// <exception cref="Microsoft.IdentityModel.Tokens.ValidationFailure">BeforeEntry - BeforeEntry query string parameter requires exactly 1 value.</exception>
    ...
    /// <exception cref="Microsoft.IdentityModel.Tokens.ValidationFailure">BeforeEntry - BeforeEntry query string parameter value must be an integer.</exception>
