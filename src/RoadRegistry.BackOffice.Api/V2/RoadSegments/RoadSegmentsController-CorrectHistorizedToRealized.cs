...
{
    private const string CorrectHistorizedToRealizedRoute = "{id}/acties/corrigeren/gehistoreerdnaargerealiseerd";

    /// <summary>
    ///     Corrigeer een gehistoreerd wegsegment naar gerealiseerd.
    /// </summary>
    ...
    [HttpPost(CorrectHistorizedToRealizedRoute, Name = nameof(CorrectRoadSegmentFromHistorizedToRealizedV2))]
