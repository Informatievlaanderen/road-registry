...
public class ProjectionFormat
{
    ...
    public static readonly ProjectionFormat BelgeLambert2008 = new("""PROJCS["Belge_Lambert_2008",GEOGCS["GCS_ETRS_1989",DATUM["D_ETRS_1989",SPHEROID["GRS_1980",6378137.0,298.257222101]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Lambert_Conformal_Conic"],PARAMETER["False_Easting",649328.0],PARAMETER["False_Northing",665262.0],PARAMETER["Central_Meridian",4.359215833333333],PARAMETER["Standard_Parallel_1",49.83333333333334],PARAMETER["Standard_Parallel_2",51.16666666666666],PARAMETER["Latitude_Of_Origin",50.797815],UNIT["Meter",1.0]]""");
    ...
    public bool IsBelgeLambert2008()
    {
        try
        {
            var projectionInfo = ProjectionInfo.FromEsriString(Content);
            ...
            return string.Equals(projectionInfo.Name, "Belge_Lambert_2008", StringComparison.OrdinalIgnoreCase);
        }
        catch (InvalidEsriFormatException)
        {
            return false;
