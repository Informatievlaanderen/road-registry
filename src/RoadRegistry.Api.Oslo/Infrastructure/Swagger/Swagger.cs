namespace RoadRegistry.Api.Oslo.Infrastructure.Swagger
{
    using System;
    using System.IO;
    using System.Linq;
...
Welkom bij de referentie voor de REST API van het RoadRegistry!
...
Het RoadRegistry stelt u in staat om:
...
De REST API van het RoadRegistry is te bereiken via volgende ontsluitingen.
...
Momenteel leest u de documentatie voor het RoadRegistry {description.ApiVersion}{string.Format(description.IsDeprecated ? ", deze API versie is niet meer ondersteund." : string.Empty)}
