    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletedRoadNodes", x => x.WK_OIDN)
                        .Annotation("SqlServer:Clustered", true);
                });

            migrationBuilder.CreateTable(
                name: "CompletedRoadSegments",
                schema: "RoadRegistry",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletedRoadSegments", x => x.WS_OIDN)
                        .Annotation("SqlServer:Clustered", true);
                });
