...
Execute unit tests
```
    cd "RoadRegistry.Snapshot.Handlers.Sqs.Lambda.Proxy/test/RoadRegistry.Snapshot.Handlers.Sqs.Lambda.Proxy.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "RoadRegistry.Snapshot.Handlers.Sqs.Lambda.Proxy/src/RoadRegistry.Snapshot.Handlers.Sqs.Lambda.Proxy"
