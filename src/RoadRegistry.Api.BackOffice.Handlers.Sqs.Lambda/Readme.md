...
Execute unit tests
```
    cd "RoadRegistry.Api.BackOffice.Handlers.Sqs.Lambda/test/RoadRegistry.Api.BackOffice.Handlers.Sqs.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "RoadRegistry.Api.BackOffice.Handlers.Sqs.Lambda/src/RoadRegistry.Api.BackOffice.Handlers.Sqs.Lambda"
