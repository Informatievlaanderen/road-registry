...
viewFooter () =
    footer []
        [ div
            [ style "height" "0", style "width" "0", style "position" "absolute", style "visibility" "hidden", style "display" "none" ]
            [ svg
                ...
                [ symbol
                    ...
                    , path
                        [ attribute "data-name" "Logo Vlaanderen"
        ...
        , div
            ...
            [ div
                [ id "vlaanderen-footer-logo" ]
                [ svg
                    [ xmlSpace "http://www.w3.org/2000/svg" ]
                    [ use
                        [ attribute "xmlns:xlink" "http://www.w3.org/1999/xlink"
                        , xlinkHref "#vlaanderen-logo"
                        ]
                        []
                    ]
                , text " " -- can't touch this
                , div
                    [ id "vlaanderen-footer-logo-text" ]
                    [ div
                        [ id "vlaanderen-footer-logo-title" ]
                        [ text "Vlaanderen" ]
                    , div
                        [ id "vlaanderen-footer-logo-tagline" ]
                        [ text "verbeelding werkt" ]
                    ]
                ]
            , div
                [ id "vlaanderen-footer-info" ]
                [ div
                    [ id "vlaanderen-footer-info-title" ]
                    [ text "Dit is een officiële website van de Vlaamse overheid" ]
                , div
                    [ id "vlaanderen-footer-info-publisher" ]
                    [ span
                        []
                        [ text "uitgegeven door " ]
                    , span
                        [ itemprop "publisher", attribute "itemscope" "", attribute "itemtype" "http://schema.org/Organization" ]
                        [ a
