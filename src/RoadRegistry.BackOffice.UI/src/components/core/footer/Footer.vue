...
export default {
  ...
  methods: {
    setVersion() {
      // TODO: Get version
      // document.getElementById('version').innerHTML = `, versie ${window.wegenregisterVersion}`;
      // eslint-disable-next-line
      console.log('TODO: setVersion');
    },
  },
  mounted() {
    if(window.wegenregisterVersion) {
      document.getElementById("wrVersion").innerHTML = ', versie ' + window.wegenregisterVersion;
    } else {
      document.getElementById("wrVersion").innerHTML = ', developer versie';
    }
  },
};
</script>
