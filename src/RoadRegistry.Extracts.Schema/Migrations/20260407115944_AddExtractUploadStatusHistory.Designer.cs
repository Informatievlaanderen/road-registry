...
namespace RoadRegistry.Extracts.Schema.Migrations
{
    ...
    [Migration("20260407115944_AddExtractUploadStatusHistory")]
    partial class AddExtractUploadStatusHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoadRegistry.Extracts.Schema.InwinningRoadSegment", b =>
                {
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("RoadSegmentId"));
