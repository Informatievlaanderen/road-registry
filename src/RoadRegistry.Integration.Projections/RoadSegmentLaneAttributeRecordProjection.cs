...
public class RoadSegmentLaneAttributeRecordProjection : ConnectedProjection<IntegrationContext>
{
    ...
    private static async Task RemoveRoadSegment(IntegrationContext context, RoadSegmentRemoved segment, CancellationToken token)
    {
