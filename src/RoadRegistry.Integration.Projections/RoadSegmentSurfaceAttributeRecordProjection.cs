...
public class RoadSegmentSurfaceAttributeRecordProjection : ConnectedProjection<IntegrationContext>
{
    ...
    private static async Task RemoveRoadSegment(IntegrationContext context, RoadSegmentRemoved segment,
        CancellationToken token)
    {
