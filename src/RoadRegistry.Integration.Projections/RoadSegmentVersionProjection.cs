...
public class RoadSegmentVersionProjection : ConnectedProjection<IntegrationContext>
{
        ...
        CancellationToken token)
    {
        ...
        {
            latestItem = new RoadSegmentVersion
            {
        ...
        CancellationToken token)
    {
        ...
        if (latestItem is null)
        {
            throw new InvalidOperationException($"{nameof(RoadSegmentVersion)} with id {roadSegmentAttributesModified.Id} is not found");
        }
        ...
        CancellationToken token)
    {
        ...
        if (latestItem is null)
        {
            throw new InvalidOperationException($"{nameof(RoadSegmentVersion)} with id {roadSegmentGeometryModified.Id} is not found");
        }
        ...
        CancellationToken token)
    {
        ...
        if (latestItem is null)
        {
            throw new InvalidOperationException($"{nameof(RoadSegmentVersion)} with id {segmentId} is not found");
        }
