    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "RoadRegistryGradeSeparatedJunctionProducerSnapshotSchema");

            migrationBuilder.EnsureSchema(
                name: "RoadRegistryGradeSeparatedJunctionProducerSnapshotMetaSchema");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowerRoadSegmentId = table.Column<int>(type: "int", nullable: false),
                    UpperRoadSegmentId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                schema: "RoadRegistryGradeSeparatedJunctionProducerSnapshotMetaSchema",
                columns: table => new
                {
