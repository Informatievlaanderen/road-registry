...
namespace RoadRegistry.Wms.Schema.Migrations
{
    ...
    [Migration("20250120152537_AddTransactionZones")]
    partial class AddTransactionZones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoadRegistry.Wms.Schema.OverlappingTransactionZonesRecord", b =>
                {
                    ...
                    b.ToTable("OverlappendeBijwerkingszones", "RoadRegistryWmsMeta");
                });
            ...
            modelBuilder.Entity("RoadRegistry.Wms.Schema.TransactionZoneRecord", b =>
                {
                    ...
                    b.ToTable("Bijwerkingszones", "RoadRegistryWmsMeta");
                });
