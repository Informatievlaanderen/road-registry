...
namespace RoadRegistry.Wms.Schema.Migrations
{
    ...
    [Migration("20260925125011_AddRoadSegmentIsV2MorphologyIndex")]
    partial class AddRoadSegmentIsV2MorphologyIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoadRegistry.Wms.Schema.RoadSegmentRecord", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("AccessRestrictionId"), false);
                    ...
                    b.HasIndex("RightSideStreetName");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("RightSideStreetName"), false);
                    ...
                    b.HasIndex("IsV2", "MorphologyId")
                        .HasDatabaseName("nci_msft_1_wegsegmentDenorm_0DB1125C0F3780A74F7979055E2293D6")
                        .HasAnnotation("SqlServer:Online", true);

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("IsV2", "MorphologyId"), false);
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsV2", "MorphologyId"), new[] { "MaintainerId", "Geometry2D", "AccessRestrictionId" });
