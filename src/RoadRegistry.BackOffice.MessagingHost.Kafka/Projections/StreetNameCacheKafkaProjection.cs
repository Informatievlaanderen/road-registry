...
//        private static async Task UpdateStreetNameRecord<T>(StreetNameConsumerContext context, Be.Vlaanderen.Basisregisters.ProjectionHandling.SqlStreamStore.Envelope<T> envelope, Guid streetNameId, Action<StreetNameRecord> update, CancellationToken token)
//            where T: IMessage
//        {
...
//        private static async Task<StreetNameRecord> FindOrThrow(StreetNameConsumerContext context, Guid streetNameId, CancellationToken token)
//        {
