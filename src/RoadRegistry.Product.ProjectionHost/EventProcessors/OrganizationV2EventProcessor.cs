...
public class OrganizationV2EventProcessor : ProductContextEventProcessor
{
    public OrganizationV2EventProcessor(
        ...
        : base("roadregistry-product-organization-v2-projectionhost", streamStore, projections.Filter, envelopeFactory, projections.Resolver, dbContextFactory, scheduler, loggerFactory)
    {
    }
}
