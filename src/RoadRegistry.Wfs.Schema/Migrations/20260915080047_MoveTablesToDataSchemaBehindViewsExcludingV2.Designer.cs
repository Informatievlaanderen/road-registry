...
namespace RoadRegistry.Wfs.Schema.Migrations
{
    ...
    [Migration("20260915080047_MoveTablesToDataSchemaBehindViewsExcludingV2")]
    partial class MoveTablesToDataSchemaBehindViewsExcludingV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoadRegistry.Wfs.Schema.RoadSegmentRecord", b =>
                {
                    ...
                    b.HasIndex("AccessRestriction");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("AccessRestriction"), false);

                    b.HasIndex("BeginRoadNodeId");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("BeginRoadNodeId"), false);

                    b.HasIndex("CategoryDutchName");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("CategoryDutchName"), false);

                    b.HasIndex("EndRoadNodeId");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("EndRoadNodeId"), false);
                    ...
                    b.HasIndex("MethodDutchName");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("MethodDutchName"), false);

                    b.HasIndex("MorphologyDutchName");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("MorphologyDutchName"), false);

                    b.HasIndex("RightSideStreetNameId");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("RightSideStreetNameId"), false);

                    b.HasIndex("StatusDutchName");
