...
//     {
//         var extract1 = _fixture.Create<RoadNetworkExtractGotRequested>().Contour;
//         var extract2 = _fixture.Create<RoadNetworkExtractGotRequested>();
//
//         var data =
//             // _fixture.CreateMany<RoadNetworkExtractGotRequested>()
//             new[] { extract1, extract2 }
//             .Select(requested =>
//             {
//                 var expected = new OverlappingTransactionZonesRecord
//                 {
//                     DownloadId1 = requested.DownloadId,
