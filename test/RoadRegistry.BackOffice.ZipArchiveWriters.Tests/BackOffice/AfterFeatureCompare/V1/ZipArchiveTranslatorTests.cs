                ...
                TranslatedChanges.Empty
                    ...
                    .AppendChange(
                        new AddRoadSegment(
                                ...
                                roadSegmentChangeDbaseRecord1.LSTRNMID.Value.HasValue ? new StreetNameLocalId(roadSegmentChangeDbaseRecord1.LSTRNMID.Value.GetValueOrDefault()) : default,
                                roadSegmentChangeDbaseRecord1.RSTRNMID.Value.HasValue ? new StreetNameLocalId(roadSegmentChangeDbaseRecord1.RSTRNMID.Value.GetValueOrDefault()) : default
                            )
                    ...
                    .AppendChange(
                        new AddRoadSegment(
                            ...
                            roadSegmentChangeDbaseRecord2.LSTRNMID.Value.HasValue ? new StreetNameLocalId(roadSegmentChangeDbaseRecord2.LSTRNMID.Value.GetValueOrDefault()) : default,
                            roadSegmentChangeDbaseRecord2.RSTRNMID.Value.HasValue ? new StreetNameLocalId(roadSegmentChangeDbaseRecord2.RSTRNMID.Value.GetValueOrDefault()) : default
