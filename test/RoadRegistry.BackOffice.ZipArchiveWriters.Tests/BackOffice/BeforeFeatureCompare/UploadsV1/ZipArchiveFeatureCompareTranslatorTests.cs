...
public class ZipArchiveFeatureCompareTranslatorTests
{
    ...
    public async Task AddShouldSucceed()
    {
        ...
        var zipArchive = CreateZipArchive(fixture, testData,
    ...
    private static ZipArchive CreateZipArchive(Fixture fixture, ExtractsZipArchiveTestData testData,
    ...
    )
    {
        ...
        using (var createArchive = new ZipArchive(archiveStream, ZipArchiveMode.Create, true, Encoding))
        {
            foreach (var file in testData.ExtractFileNames)
            {
        ...
        return new ZipArchive(archiveStream, ZipArchiveMode.Read, false, Encoding);
    }
