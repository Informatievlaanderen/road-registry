...
//             Geometry = new Point(600000, 600000).ToRoadNodeGeometry(),
//             Grensknoop = false
//         };
//         var node2 = new AddRoadNodeChange
//         {
//             TemporaryId = new RoadNodeId(2),
//             Geometry = new Point(600010, 600000).ToRoadNodeGeometry(),
//             Grensknoop = false
//         };
//         var node3 = new AddRoadNodeChange
//         {
//             TemporaryId = new RoadNodeId(3),
//             Geometry = new Point(600020, 600000).ToRoadNodeGeometry(),
//             Grensknoop = false
//         };
...
//         {
//             RoadSegmentIdReference = new RoadSegmentIdReference(new RoadSegmentId(2)),
...
//         {
//             RoadSegmentIdReference = new RoadSegmentIdReference(new RoadSegmentId(3)),
...
//             LowerRoadSegmentId = segment1_node_1_2.RoadSegmentIdReference.RoadSegmentId,
//             UpperRoadSegmentId = segment2_node_2_3.RoadSegmentIdReference.RoadSegmentId
//         };
//
...
//         roadNodes.Single(x => x.RoadNodeId == node2.TemporaryId).Type.Should().Be(RoadNodeTypeV2.Eindknoop);
//
//         var roadSegments = await session.LoadManyAsync([
//             segment1_node_1_2.RoadSegmentIdReference.RoadSegmentId,
//             segment2_node_2_3.RoadSegmentIdReference.RoadSegmentId,
//             segment3.RoadSegmentIdReference.RoadSegmentId]);
