...
// using RoadRegistry.Wms.ProjectionHost.Tests.Projections;
// using RoadRegistry.Wms.ProjectionHost.Tests.Projections.Framework;
// using RoadRegistry.Wms.Projections;
// using RoadRegistry.Wms.Projections.MartenDb;
// using RoadRegistry.Wms.Schema;
// using RoadSegment;
// using RoadSegment.Events;
// using Tests.Framework.Projections;
// using RoadSegmentRecordProjection = RoadRegistry.Wms.Projections.MartenDb.RoadSegmentRecordProjection;
// using StreetNameRecord = Sync.StreetNameRegistry.Models.StreetNameRecord;
//
// //TODO-pr na verhuis ook WmsProjection host project reference verwijderen
//
...
//
//     public RoadSegmentRecordProjectionTests(DatabaseFixture databaseFixture)
//     {
...
//     {
//         var messages = _fixture.CreateMany<RoadSegmentAdded>().ToArray();
//
//         var expectedRecords = messages
//             .Select(message => BuildRoadSegmentRecord(message, _ => { }))
//             .ToArray();
//
//         return CreateProjectionTestRunner()
//             .Given<RoadSegment, RoadSegmentId>(evt => ((RoadSegmentAdded)evt).Id, messages.Cast<object>().ToArray())
//             .Assert(async (sp, session) =>
//             {
//                 //TODO-pr resolve Idbcontextfactory en create context via that factory
//
...
//
//                 //TODO-pr handle verificationresult, zie WmsContextScenarioExtensions
//             });
//     }
//     //
//     // [Fact]
...
//     }
//
//     private DbContextRoadNetworkChangesProjectionTestRunner<WmsContext> CreateProjectionTestRunner()
//     {
...
//
//         var dbContextFactory = new Mock<IDbContextFactory<WmsContext>>();
//         dbContextFactory
//             .Setup(x => x.CreateDbContextAsync(It.IsAny<CancellationToken>()))
//             .ReturnsAsync(() => CreateContextFor(database));
//
//         var runner = new DbContextRoadNetworkChangesProjectionTestRunner<WmsContext>(_databaseFixture, database);
//         runner.ConfigureServices(services =>
//         {
//             services.AddSingleton(dbContextFactory.Object);
//         });
//         runner.ConfigureRoadNetworkChangesProjection([
//                 new WmsRoadNetworkChangesProjection(
...
// }
//
// public class DbContextRoadNetworkChangesProjectionTestRunner<TDbContext> : MartenProjectionTestRunner
//     where TDbContext : RunnerDbContext<TDbContext>
// {
//     public string DatabaseName { get; }
//
//     public DbContextRoadNetworkChangesProjectionTestRunner(DatabaseFixture databaseFixture, string databaseName)
