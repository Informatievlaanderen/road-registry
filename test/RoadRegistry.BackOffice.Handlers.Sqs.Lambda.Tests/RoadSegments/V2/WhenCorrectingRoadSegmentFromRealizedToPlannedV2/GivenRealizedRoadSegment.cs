namespace RoadRegistry.BackOffice.Handlers.Sqs.Lambda.Tests.RoadSegments.V2.WhenCorrectingRoadSegmentFromRealizedToPlannedV2;
...
using RoadRegistry.BackOffice.Handlers.Sqs.Lambda.Actions.CorrectRoadSegmentFromRealizedToPlanned;
...
public class GivenRealizedRoadSegment : BackOfficeLambdaTest
{
    ...
    public GivenRealizedRoadSegment(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
    {
    }
        ...
        bool seedTheRoadSegment = true)
    {
        ...
        var handler = new CorrectRoadSegmentFromRealizedToPlannedV2SqsLambdaRequestHandler(
        ...
        await handler.Handle(new CorrectRoadSegmentFromRealizedToPlannedV2SqsLambdaRequest(Guid.NewGuid().ToString(), sqsRequest), CancellationToken.None);
    }
