...
public class LinkStreetNameRequestHandlerTests : LinkUnlinkStreetNameTestsBase
{
    ...
    public async Task LinkStreetNameToRoadSegment_LeftAndRightStreetName_Proposed_Current(int streetNameId)
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(streetNameId), StreetNamePuri(streetNameId)));
    ...
    public void LinkStreetNameToRoadSegment_LeftOrRightStreetName_IsRequired()
    {
        ...
        var validationResult = validator.Validate(new LinkStreetNameRequest(new RoadSegmentId(1), null, null, null));
    ...
    public async Task LinkStreetNameToRoadSegment_LeftStreetName_AlreadyLinked()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(WellKnownStreetNameIds.Proposed), null));
    ...
    public async Task LinkStreetNameToRoadSegment_LeftStreetName_NotExists()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(99999), null));
    ...
    public async Task LinkStreetNameToRoadSegment_LeftStreetName_NotFound()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(WellKnownStreetNameIds.Null), null));
    ...
    public async Task LinkStreetNameToRoadSegment_LeftStreetName_Proposed_Current(int streetNameId)
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(streetNameId), null));
    ...
    public async Task LinkStreetNameToRoadSegment_LeftStreetName_Retired()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(WellKnownStreetNameIds.Retired), null));
    ...
    public async Task LinkStreetNameToRoadSegment_RightStreetName_AlreadyLinked()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, null, StreetNamePuri(WellKnownStreetNameIds.Proposed)));
    ...
    public async Task LinkStreetNameToRoadSegment_RightStreetName_NotExists()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, null, StreetNamePuri(99999)));
    ...
    public async Task LinkStreetNameToRoadSegment_RightStreetName_Proposed_Current(int streetNameId)
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, null, StreetNamePuri(streetNameId)));
    ...
    public async Task LinkStreetNameToRoadSegment_RightStreetName_Retired()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new LinkStreetNameRequest(roadSegmentId, null, null, StreetNamePuri(WellKnownStreetNameIds.Retired)));
