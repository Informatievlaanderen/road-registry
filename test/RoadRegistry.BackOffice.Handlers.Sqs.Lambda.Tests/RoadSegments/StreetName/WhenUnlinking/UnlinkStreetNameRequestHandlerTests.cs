...
public class UnlinkStreetNameRequestHandlerTests : LinkUnlinkStreetNameTestsBase
{
    ...
    public async Task UnlinkStreetNameFromRoadSegment_LeftAndRightStreetName_Succeeded()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(WellKnownStreetNameIds.Proposed), StreetNamePuri(WellKnownStreetNameIds.Proposed)));
    ...
    public void UnlinkStreetNameFromRoadSegment_LeftOrRightStreetName_IsRequired()
    {
        ...
        var validationResult = validator.Validate(new UnlinkStreetNameRequest(new RoadSegmentId(1), null, null, null));
    ...
    public async Task UnlinkStreetNameFromRoadSegment_LeftStreetName_NotLinked()
    {
        ...
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, linkerstraatnaamPuri, null));
    ...
    public async Task UnlinkStreetNameFromRoadSegment_LeftStreetName_Succeeded()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(WellKnownStreetNameIds.Proposed), null));
    ...
    public async Task UnlinkStreetNameFromRoadSegment_RightStreetName_NotLinked()
    {
        ...
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, null, rechterstraatnaamPuri));
    ...
    public async Task UnlinkStreetNameFromRoadSegment_RightStreetName_Succeeded()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, null, StreetNamePuri(WellKnownStreetNameIds.Proposed)));
    ...
    public async Task UnlinkStreetNameFromRoadSegment_RoadSegment_NotExists()
    {
        ...
        //Act
        await HandleRequest(ticketing.Object, new UnlinkStreetNameRequest(roadSegmentId, null, StreetNamePuri(99999), null));
