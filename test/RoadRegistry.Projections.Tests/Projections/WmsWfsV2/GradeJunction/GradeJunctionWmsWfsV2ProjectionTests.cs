...
public class GradeJunctionWmsWfsV2ProjectionTests
{
    ...
    private WmsWfsV2ProjectionScenario Scenario() =>
        new(new GradeJunctionWmsWfsV2Projection());
    ...
    public void EnsureAllEventsAreHandledExactlyOnce()
    {
        ...
        var excludeEventTypes = new[]
        {
            ...
            typeof(RoadSegmentV2.RoadSegmentWasModified),
            typeof(RoadSegmentV2.RoadSegmentWasRealizedFromPlanned),
            typeof(RoadSegmentV2.RoadSegmentWasRealizedFromOutOfUse),
            typeof(RoadSegmentV2.RoadSegmentWasCorrectedFromHistorizedToRealized),
            typeof(RoadSegmentV2.RoadSegmentWasCorrectedFromRealizedToPlanned),
            typeof(RoadSegmentV2.RoadSegmentWasTakenOutOfUseFromRealized),
            typeof(RoadSegmentV2.RoadSegmentWasHistorizedFromRealized),
            ...
            typeof(RoadSegmentV2.RoadSegmentWasRemovedFromNationalRoad), typeof(RoadSegmentV2.RoadSegmentWasRetiredBecauseOfMerger), typeof(RoadSegmentV2.RoadSegmentWasRetiredBecauseOfSplit),
        ...
        WmsWfsV2ProjectionEventCoverage.AssertHandledExactlyOnce(new GradeJunctionWmsWfsV2Projection(), excludeEventTypes);
    }
