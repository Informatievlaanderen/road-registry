namespace RoadRegistry.Projections.Tests.Projections.Pbs.RoadNode;
...
public class RoadNodePbsProjectionTests
{
    ...
    public void EnsureAllEventsAreHandledExactlyOnce()
    {
        ...
        PbsProjectionEventCoverage.AssertHandledExactlyOnce(new RoadNodePbsProjection(), excludeEventTypes);
    }
