...
public class ApiAuthAttributeTests
{
    ...
    public void ItShouldAccept()
    {
        ...
        var deserializedApiToken = JsonConvert.DeserializeObject<ApiToken>(json);
    }
    ...
    public void ItShouldDeserialize()
    {
        ...
        var apiToken = ApiToken.FromBase64String(serializedApiToken);
    }

    [Fact]
    public void ItShouldSerialize()
    {
        var apiToken = new ApiToken("E9536EA5-165C-461A-8E4A-641D0A65154B", "John Doe", new ApiTokenMetadata(true))
        {
            Revoked = false
        };
