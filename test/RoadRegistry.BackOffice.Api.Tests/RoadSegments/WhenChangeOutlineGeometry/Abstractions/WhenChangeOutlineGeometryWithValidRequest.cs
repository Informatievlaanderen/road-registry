...
public abstract class WhenChangeOutlineGeometryWithValidRequest<TFixture> : IClassFixture<TFixture>
    where TFixture : WhenChangeOutlineGeometryFixture
{
    private readonly TFixture _fixture;
    protected readonly ITestOutputHelper OutputHelper;

    protected WhenChangeOutlineGeometryWithValidRequest(TFixture fixture, ITestOutputHelper outputHelper)
    {
        _fixture = fixture;
