namespace RoadRegistry.BackOffice.Api.Tests.RoadSegments.WhenChange.Abstractions.Fixtures;
...
public abstract class WhenChangeFixture : ControllerActionFixture<ChangeRoadSegmentsParameters>
{
    private readonly EditorContext _editorContext;
    private readonly IMediator _mediator;
    public readonly RoadNetworkTestData TestData = new();

    protected WhenChangeFixture(IMediator mediator, EditorContext editorContext)
    {
        _mediator = mediator;
