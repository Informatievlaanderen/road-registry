namespace RoadRegistry.BackOffice.Framework
{
    ...
    public class StaticFactoryMethodBasedEqualsOtherAssertion : IdiomaticAssertion
    {
        public StaticFactoryMethodBasedEqualsOtherAssertion(ISpecimenBuilder builder, MethodInfo constructor)
        {
