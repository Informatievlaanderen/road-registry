namespace RoadRegistry.BackOffice.Translation
{
    ...
    public class NationalRoadChangeDbaseRecordsValidatorTests : IDisposable
    {
        ...
        private IEnumerator<NationalRoadChangeDbaseRecord> _enumerator;
        ...
        public NationalRoadChangeDbaseRecordsValidatorTests()
        {
            ...
            _enumerator = new List<NationalRoadChangeDbaseRecord>().GetEnumerator();
        ...
        public void ValidateWithProblematicRecordsReturnsExpectedResult()
        {
            ...
            var enumerator = new ProblematicRecordEnumerator<NationalRoadChangeDbaseRecord>(records, 1, exception);
