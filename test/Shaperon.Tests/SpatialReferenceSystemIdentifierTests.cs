namespace Shaperon
{
    ...
    public class SpatialReferenceSystemIdentifierTests
    {
        ...
        {
            Assert.Equal(new SpatialReferenceSystemIdentifier(103300), SpatialReferenceSystemIdentifier.BelgeLambert1972);
        }
        ...
        {
            Assert.IsAssignableFrom<IEquatable<SpatialReferenceSystemIdentifier>>(_fixture.Create<SpatialReferenceSystemIdentifier>());
        }
    }
}
