namespace RoadRegistry.Tests
{
    ...
    public static class ZipArchiveFeatureCompareTranslatorFactory
    {
        ...
        public static IZipArchiveFeatureCompareTranslator Create(IOrganizationCache organizationCache = null)
        {
            return new ZipArchiveFeatureCompareTranslator(
                ...
                new RoadSegmentFeatureCompareTranslator(new RoadSegmentFeatureCompareFeatureReader(Encoding), organizationCache ?? new FakeOrganizationCache()),
