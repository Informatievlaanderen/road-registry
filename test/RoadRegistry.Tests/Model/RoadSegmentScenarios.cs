//TODO: Need to integrate these with the rest of the road network tests.
...
//        {
//            var temporaryStartNodeId = Fixture.Create<RoadNodeId>();
//            var temporaryEndNodeId = Fixture.Create<RoadNodeId>();
//            var temporarySegmentId = Fixture.Create<RoadSegmentId>();
...
//                            {
//                                TemporaryId = temporaryStartNodeId,
...
//                            AddRoadNode = new Messages.AddRoadNode
//                            {
//                                TemporaryId = temporaryEndNodeId,
//                                Type = RoadNodeType.FakeNode,
//                                Geometry = end
//                            }
//                        },
...
//                            {
//                                TemporaryId = temporarySegmentId,
//                                StartNodeId = temporaryStartNodeId,
//                                EndNodeId = temporaryEndNodeId,
//                                Geometry = line,
...
//            var temporaryStartNodeId = Fixture.Create<RoadNodeId>();
//            var temporaryEndNodeId = Fixture.Create<RoadNodeId>();
//            var temporarySegmentId1 = Fixture.Create<RoadSegmentId>();
//            var temporarySegmentId2 = Fixture.Create<RoadSegmentId>();
//            var start = GeometryTranslator.Translate(Fixture.Create<PointM>());
//            var end = GeometryTranslator.Translate(Fixture.Create<PointM>());
//            var line = GeometryTranslator.Translate(Fixture.Create<MultiLineString>());
//            return Run(scenario =>
...
//                                {
//                                    Id = 1,
//                                    TemporaryId = temporarySegmentId1,
//                                    StartNodeId = 1,
//                                    EndNodeId = 2,
//                                    Geometry = line,
//                                    GeometryVersion = 0,
...
//                            AddRoadSegment = new Messages.AddRoadSegment
//                            {
//                                TemporaryId = temporarySegmentId2,
//                                StartNodeId = 1,
//                                EndNodeId = 2,
//                                Geometry = line,
//                                MaintenanceAuthority = maintainer,
