...
{
    public static void CustomizeDomainV2RoadNodeDbaseRecord(this IFixture fixture)
    {
    ...
    public static void CustomizeDomainV2RoadSegmentDbaseRecord(this IFixture fixture)
    {
        fixture.Customize<RoadSegmentDbaseRecord>(composer => composer
            .FromFactory(random => new RoadSegmentDbaseRecord
            {
                ...
                METHODE = { Value = fixture.Create<RoadSegmentGeometryDrawMethodV2>().Translation.Identifier },
    ...
    public static void CustomizeDomainV2RoadSegmentEuropeanRoadAttributeDbaseRecord(this IFixture fixture)
    {
    ...
    public static void CustomizeDomainV2RoadSegmentNationalRoadAttributeDbaseRecord(this IFixture fixture)
    {
    ...
    public static void CustomizeDomainV2GradeSeparatedJunctionDbaseRecord(this IFixture fixture)
    {
    ...
    public static void CustomizeDomainV2TransactionZoneDbaseRecord(this IFixture fixture)
    {
