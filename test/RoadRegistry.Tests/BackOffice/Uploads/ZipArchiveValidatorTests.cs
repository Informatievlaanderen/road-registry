    ...
    private static ZipArchive CreateArchiveWithEmptyFiles()
    {
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<RoadSegmentChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<EuropeanRoadChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<NationalRoadChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<NumberedRoadChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<RoadSegmentLaneChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<RoadSegmentWidthChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<RoadSegmentSurfaceChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<RoadNodeChangeDbaseRecord>());
        }
        ...
        using (var writer = new DbaseBinaryWriter(
                   ...
                   new BinaryWriter(
                       ...
                       true)))
        {
            writer.Write(Array.Empty<GradeSeparatedJunctionChangeDbaseRecord>());
        }
