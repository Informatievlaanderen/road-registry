    ...
    public class RoadSegmentSnapshotEqualityComparer : IEqualityComparer<RoadSegmentSnapshot>
    {
        public bool Equals(RoadSegmentSnapshot left, RoadSegmentSnapshot right)
        {
            ...
            return left.Id.Equals(right.Id)
                   && left.BeginOperator.Equals(right.BeginOperator)
                   && left.BeginOrganizationId.Equals(right.BeginOrganizationId)
                   && left.BeginOrganizationName.Equals(right.BeginOrganizationName)
                   && left.BeginTime.Equals(right.BeginTime)
                   && left.BeginApplication.Equals(right.BeginApplication)
                   && left.MaintainerId.Equals(right.MaintainerId)
                   && left.MaintainerName.Equals(right.MaintainerName)
                   && left.MethodId.Equals(right.MethodId)
                   && left.MethodDutchName.Equals(right.MethodDutchName)
                   && left.CategoryId.Equals(right.CategoryId)
                   && left.CategoryDutchName.Equals(right.CategoryDutchName)
                   ...
                   && left.MorphologyDutchName.Equals(right.MorphologyDutchName)
                   && left.StatusId.Equals(right.StatusId)
                   && left.StatusDutchName.Equals(right.StatusDutchName)
                   && left.AccessRestrictionId.Equals(right.AccessRestrictionId)
                   && left.AccessRestrictionDutchName.Equals(right.AccessRestrictionDutchName)
                   ...
                   && left.LeftSideMunicipalityNisCode.Equals(right.LeftSideMunicipalityNisCode)
                   && left.LeftSideStreetNameId.Equals(right.LeftSideStreetNameId)
                   && left.LeftSideStreetName.Equals(right.LeftSideStreetName)
                   && left.RightSideMunicipalityId.Equals(right.RightSideMunicipalityId)
                   && left.RightSideMunicipalityNisCode.Equals(right.RightSideMunicipalityNisCode)
                   && left.RightSideStreetNameId.Equals(right.RightSideStreetNameId)
                   && left.RightSideStreetName.Equals(right.RightSideStreetName)
