namespace RoadRegistry.Framework.Assertions
{
    ...
    /// representing a method or constructor) is invoked with a <see cref="Int64" /> less than 0 argument.
    /// </summary>
    /// <seealso cref="Verify(IGuardClauseCommand)" />
    public class NegativeInt64BehaviorExpectation : IBehaviorExpectation
    {
        /// <summary>
        /// Verifies the behavior of the command when invoked with <see cref="Int64" /> less than 0.
        /// </summary>
        ...
        /// invoked with <see cref="Int64" /> less than 0 as one of the method arguments. In that case it's
