...
public class StaticFactoryMethodBasedEqualityOperatorEqualsOtherAssertion : IdiomaticAssertion
{
    public StaticFactoryMethodBasedEqualityOperatorEqualsOtherAssertion(ISpecimenBuilder builder, MethodInfo constructor)
    {
