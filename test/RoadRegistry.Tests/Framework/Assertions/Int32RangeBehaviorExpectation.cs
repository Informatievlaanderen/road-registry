...
///     representing a method or constructor) is invoked with a <see cref="int" /> less than 0 argument.
/// </summary>
...
public class Int32RangeBehaviorExpectation : IBehaviorExpectation
{
    ...
    ///         invoked with <see cref="int" /> less than 0 as one of the method arguments. In that case it's
