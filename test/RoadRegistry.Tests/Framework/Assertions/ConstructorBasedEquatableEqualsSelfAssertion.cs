...
public class ConstructorBasedEquatableEqualsSelfAssertion : IdiomaticAssertion
{
    public ConstructorBasedEquatableEqualsSelfAssertion(ISpecimenBuilder builder, ConstructorInfo constructor)
    {
