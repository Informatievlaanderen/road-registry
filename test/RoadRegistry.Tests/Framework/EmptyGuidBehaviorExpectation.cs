namespace RoadRegistry
{
    ...
    /// <see cref="System.String"/> argument it should raise an <see cref="ArgumentNullException" />. If
    ...
    public class EmptyStringBehaviorExpectation : IBehaviorExpectation
    {
        ...
        /// <see cref="IGuardClauseCommand.Execute" /> with <see cref="System.String"/>. The expected
